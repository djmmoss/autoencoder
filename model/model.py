...
n_weights = {
        ...
        'w_l4' : tf.Variable(tf.truncated_normal([Layer_3,Layer_2], stddev=0.1), name="w_l4"),
        'w_l5' : tf.Variable(tf.truncated_normal([Layer_2,Layer_1], stddev=0.1), name="w_l5"),
}

n_biases = {
        'b_l2' : tf.Variable(tf.constant(0.1, shape=[Layer_2]), name="b_l2"),
        'b_l3' : tf.Variable(tf.constant(0.1, shape=[Layer_3]), name="b_l3"),
        'b_l4' : tf.Variable(tf.constant(0.1, shape=[Layer_2]), name="b_l4"),
        'b_l5' : tf.Variable(tf.constant(0.1, shape=[Layer_1]), name="b_l5"),
}
...
# Layer 5
pred = tf.matmul(r_l4, n_weights["w_l5"]) + n_biases["b_l5"]
